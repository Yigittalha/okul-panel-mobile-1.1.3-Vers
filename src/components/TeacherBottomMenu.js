...
const TeacherBottomMenu = ({ navigation, currentRoute = 'TeacherDashboard' }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: 'people-outline',
      activeIcon: 'people',
      route: 'TeacherSchedule', // Yoklama dersleri sayfası
      color: '#10B981',
      category: 'main'
    },
    {
...
export default TeacherBottomMenu;